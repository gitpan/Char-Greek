...
# eval (omit) has eval "..."
$_ = <<'END';
eval Char::Greek::escape " if ('้ม' =~ /[แ]/i) { return 1 } else { return 0 } "
END
if (eval Char::Greek::escape) {
...
$_ = <<'END';
eval Char::Greek::escape qq{ if ('้ม' =~ /[แ]/i) { return 1 } else { return 0 } }
END
if (eval Char::Greek::escape) {
...
# eval (omit) has eval '...'
$_ = <<'END';
eval Char::Greek::escape ' if (qq{้ม} =~ /[แ]/i) { return 1 } else { return 0 } '
END
if (eval Char::Greek::escape) {
...
$_ = <<'END';
eval Char::Greek::escape q{ if ('้ม' =~ /[แ]/i) { return 1 } else { return 0 } }
END
if (eval Char::Greek::escape) {
