...
10% everything else. But this "text" means US-ASCII text, and popular Greek
...
Perl3 or later can treat Greek.

Perl is designed to make the easy jobs easy, without making the hard jobs
impossible. Char::Greek software is Perl program designed to make the "easy jobs easy".
...
=item * Handles Raw Greek, Doesn't use UTF8 flag like JPerl
...
Definitions in Char/Egreek.pm.
  ...
  ${Char::Egreek::not_space}      qr{(?:[^\x09\x0A\x0B\x0C\x0D\x20])}
...
It has already been achieved by Greek designed for combining with
...
Contrasting is Encode module and describing "use Char::Greek;" on this software,
