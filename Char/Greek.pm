...
Let's start with a bit of history: jperl 4.019+1.3 introduced Greek support.
...
In this country, Greek is widely used on mainframe I/O, the personal computer,
and the cellular phone. This software treats Greek directly, but doesn't treat
