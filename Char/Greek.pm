...
END
            ...
            if ($list !~ /\A \s* \z/oxms) {
                ...
                for (@list) {
                    $Char::Egreek::function_ord     = 'Char::Greek::ord'     if /\A ord \z/oxms;
                    $Char::Egreek::function_ord_    = 'Char::Greek::ord_'    if /\A ord \z/oxms;
                    $Char::Egreek::function_reverse = 'Char::Greek::reverse' if /\A reverse \z/oxms;
                    $Char::Egreek::function_getc    = 'Char::Greek::getc'    if /\A getc \z/oxms;
                }
            }
        }
    }

    $e_script .= Char::Greek::escape();
...
=head1 Calling 'Char::Egreek::ignorecase()' (Char::Greek software provides)

Char::Greek software applies calling 'Char::Egreek::ignorecase()' instead of /i modifier.
...
=head1 Un-Escaping \ of \N, \p, \P, and \X (Char::Greek software provides)

Char::Greek software removes '\' at head of alphanumeric regexp metasymbols \N, \p, \P
...
=head1 Escaping Built-in Functions (Char::Greek software provide)
...
=head1 Un-Escaping bytes::* Subroutines (Char::Greek software provides)

Char::Greek software removes 'bytes::' at head of subroutine name.
...
some bugs. Thus, if you happen to find a bug that's in Char::Greek software and
