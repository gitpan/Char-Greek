...
sub e_qr {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # /i modifier
        elsif ($ignorecase and (Char::Egreek::uc($char[$i]) ne Char::Egreek::lc($char[$i]))) {
...
and the cellular phone. This software treats Greek directly. Therefor there is
not UTF8 flag.
...
=item * Possible to handle raw Greek values

=item * Backward compatibility of data, script and how to

=item * Only Char/Greek.pm and Char/Egreek.pm, other modules are unnecessary
...
functions.
  ...
  ---------------------------------
  lc          Char::Egreek::lc
  lcfirst     Char::Egreek::lcfirst
  uc          Char::Egreek::uc
  ucfirst     Char::Egreek::ucfirst
  chr         Char::Egreek::chr
  glob        Char::Egreek::glob
  ---------------------------------
...
Char/Greek.pm remove 'bytes::' at head of function name.
...
=head1 Perl5.6 Emulation on perl5.005
  ...
  --------------------------------------------------------------------
  Before          After                  in BEGIN { } of Char/Egreek.pm
  --------------------------------------------------------------------
  binmode(...);   Char::Egreek::binmode(...);   *CORE::GLOBAL::binmode = ...
  open(...);      Char::Egreek::open(...);      *CORE::GLOBAL::open    = ...
  --------------------------------------------------------------------
...
=item * binmode (Perl5.6 emulation on perl5.005)
  ...
  * two arguments
  ...
  If you are using perl5.005, Char::Greek software emulate perl5.6's binmode function.
...
=item * open (Perl5.6 emulation on perl5.005)
  ...
  * three arguments
  ...
  If you are using perl5.005, Char::Greek software emulate perl5.6's open function.
  ...
  open(FH, "<:crlf:encoding(Char::Greek)", $path) or die "can't open $path: $!";
...
=head1 Ignore utf8 pragma
  ...
  ---------------------------------------------------------------------
  use utf8;       # use utf8;            Char/Egreek.pm provides utf8::*
  no utf8;        # no utf8;             functions even if 'no utf8;'
  use bytes;      # use bytes;           Char/Egreek.pm provides bytes::*
...
page 402 of Programming Perl, 3rd ed. again.
  ...
  Information processing model beginning with this software
    ...
    +-----------------------------------+
    |      ASCII Compatible Encoding    | ex. Greek
    +-----------------------------------+
                (No UTF8 Flag)
...
I am thankful to all persons.
 ...
 http://search.cpan.org/dist/Greek-Regexp/
