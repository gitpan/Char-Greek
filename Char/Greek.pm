...
######################################################################
#
# Char::Greek - Source code filter to Greek script
#
...
sub Char::Greek::escape_script {
    ...
    if (/^ use Char::Egreek(?:\s+[0-9\.]*)?\s*; $/oxms) {
        ...
        $e_script .= sprintf("use Char::Egreek %s;\n%s", $Char::Egreek::VERSION, $use_re_eval); # require run-time routines version
...
Char::Greek - Source code filter to escape Greek

=head1 SYNOPSIS

  use Char::Greek;
  use Char::Greek version;         --- require version
