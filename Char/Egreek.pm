...
BEGIN {
    ...
    sub Char::Egreek::binmode(*;$);
    sub Char::Egreek::open(*;$@);
    ...
    if ($] < 5.006) {
        ...
        if ($^O ne 'MacOS') {
            *CORE::GLOBAL::binmode =
            *CORE::GLOBAL::binmode = \&Char::Egreek::binmode;
        }
        *CORE::GLOBAL::open    =
        *CORE::GLOBAL::open    = \&Char::Egreek::open;
    }
}
...
=item Make character
  ...
  set. For example, Char::Egreek::chr(65) is "A" in either ASCII or Greek, and
  Char::Egreek::chr(0x82a0) is a Greek HIRAGANA LETTER A. For the reverse of Char::Egreek::chr,
  use Char::Greek::ord.
...
=item binary mode (Perl5.6 emulation on perl5.005)
  ...
  Char::Egreek::binmode(FILEHANDLE, $disciplines);
  Char::Egreek::binmode(FILEHANDLE);
  Char::Egreek::binmode($filehandle, $disciplines);
  Char::Egreek::binmode($filehandle);
...
=item open file (Perl5.6 emulation on perl5.005)
  ...
  $rc = Char::Egreek::open(FILEHANDLE, $mode, $expr);
  $rc = Char::Egreek::open(FILEHANDLE, $expr);
  $rc = Char::Egreek::open(FILEHANDLE);
  $rc = Char::Egreek::open(my $filehandle, $mode, $expr);
  $rc = Char::Egreek::open(my $filehandle, $expr);
  $rc = Char::Egreek::open(my $filehandle);
  ...
  * three arguments
  ...
  {
      my $fh;                          # (uninitialized)
      Char::Egreek::open($fh, ">logfile")     # $fh is autovivified
  ...
  Char::Egreek::open my $fh, ">logfile" or die ...
  ...
  Char::Egreek::open(LOG, ">", "logfile") or die "Can't create logfile: $!";
  ...
  $path =~ s#^([ ])#./$1#;
  Char::Egreek::open (FH, "< $path\0") or die "can't open $path: $!";
  ...
  Char::Egreek::open(FH, "<", $path) or die "can't open $path: $!";
  ...
  Char::Egreek::open(FH, "<:raw", $path) or die "can't open $path: $!";
  ...
  Char::Egreek::open(FH, "<:crlf:encoding(Char::Greek)", $path) or die "can't open $path: $!";
