...
#
# Greek path globbing from File::DosGlob module
#
...
This module is a run-time routines of the Char/Greek.pm.
Because the Char/Greek.pm automatically uses this module, you need not use directly.
...
=item Transliteration
  ...
  This function scans a Greek string character by character and replaces all
...
=item Chop string
  ...
  character chopped. The Char::Egreek::chop function is used primary to remove the newline
...
=item Reverse index string
  ...
  This function works just like Char::Egreek::index except that it returns the byte
...
=item Lower case string
  ...
  This function returns a lowercased version of Greek $string (or $_, if
  $string is omitted). This is the internal function implementing the \L escape
  in double-quoted strings.

  You can use the Char::Egreek::fc function for case-insensitive comparisons via Char::Greek
  software.
...
=item Lower case first character of string
  ...
  This function returns a version of Greek $string with the first character
...
=item Upper case string
  ...
  This function returns an uppercased version of Greek $string (or $_, if
...
=item Fold case string
  ...
  New to Char::Greek software, this function returns the full Unicode-like casefold of
  Greek $string (or $_, if omitted). This is the internal function implementing
...
=item Filename expansion (globbing)
  ...
  The Char::Egreek::glob function grandfathers the use of whitespace to separate multiple
