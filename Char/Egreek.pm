...
######################################################################
#
# Char::Egreek - Run-time routines for Char/Greek.pm
#
...
BEGIN {
    ...
    sub qualify ($;$) {
        my ($name) = @_;
        if (!ref($name) && (Char::Egreek::index($name, '::') == -1) && (Char::Egreek::index($name, "'") == -1)) {
            my $pkg;
...
sub import {
    ...
    if ($^O =~ /\A (?: MSWin32 | NetWare | symbian | dos ) \z/oxms) {
        ...
        for (@ARGV) {
            ...
            # has space
            if (/\A (?:$q_char)*? [ ] /oxms) {
                if (my @glob = Char::Egreek::glob(qq{"$_"})) {
                    push @argv, @glob;
                }
                else {
                    push @argv, $_;
...
#
sub unimport {}
sub Char::Egreek::split(;$$$);
sub Char::Egreek::tr($$$$;$);
sub Char::Egreek::chop(@);
sub Char::Egreek::index($$;$);
sub Char::Egreek::rindex($$;$);
sub Char::Egreek::lcfirst(@);
sub Char::Egreek::lcfirst_();
sub Char::Egreek::lc(@);
sub Char::Egreek::lc_();
sub Char::Egreek::ucfirst(@);
sub Char::Egreek::ucfirst_();
sub Char::Egreek::uc(@);
sub Char::Egreek::uc_();
sub Char::Egreek::fc(@);
sub Char::Egreek::fc_();
sub Char::Egreek::ignorecase;
sub Char::Egreek::classic_character_class;
sub Char::Egreek::capture;
sub Char::Egreek::chr(;$);
sub Char::Egreek::chr_();
sub Char::Egreek::glob($);
sub Char::Egreek::glob_();

sub Char::Greek::ord(;$);
sub Char::Greek::ord_();
sub Char::Greek::reverse(@);
sub Char::Greek::getc(;*@);
sub Char::Greek::length(;$);
sub Char::Greek::substr($$;$$);
sub Char::Greek::index($$;$);
sub Char::Greek::rindex($$;$);
sub Char::Greek::escape(;$);
...
# ${Char::Egreek::eS}        = qr{(?:[^\x09\x0A    \x0C\x0D\x20])};
# ${Char::Egreek::eS}        = qr{(?:[^\x09\x0A\x0B\x0C\x0D\x20])};
${Char::Egreek::eS}          = qr{(?:[^\s])};

${Char::Egreek::eW}          = qr{(?:[^0-9A-Z_a-z])};
${Char::Egreek::eH}          = qr{(?:[^\x09\x20])};
${Char::Egreek::eV}          = qr{(?:[^\x0A\x0B\x0C\x0D])};
${Char::Egreek::eR}          = qr{(?:\x0D\x0A|[\x0A\x0D])};
${Char::Egreek::eN}          = qr{(?:[^\x0A])};
${Char::Egreek::not_alnum}   = qr{(?:[^\x30-\x39\x41-\x5A\x61-\x7A])};
${Char::Egreek::not_alpha}   = qr{(?:[^\x41-\x5A\x61-\x7A])};
${Char::Egreek::not_ascii}   = qr{(?:[^\x00-\x7F])};
${Char::Egreek::not_blank}   = qr{(?:[^\x09\x20])};
${Char::Egreek::not_cntrl}   = qr{(?:[^\x00-\x1F\x7F])};
${Char::Egreek::not_digit}   = qr{(?:[^\x30-\x39])};
${Char::Egreek::not_graph}   = qr{(?:[^\x21-\x7F])};
${Char::Egreek::not_lower}   = qr{(?:[^\x61-\x7A])};
${Char::Egreek::not_lower_i} = qr{(?:[\x00-\xFF])};
${Char::Egreek::not_print}   = qr{(?:[^\x20-\x7F])};
${Char::Egreek::not_punct}   = qr{(?:[^\x21-\x2F\x3A-\x3F\x40\x5B-\x5F\x60\x7B-\x7E])};
${Char::Egreek::not_space}   = qr{(?:[^\s\x0B])};
${Char::Egreek::not_upper}   = qr{(?:[^\x41-\x5A])};
${Char::Egreek::not_upper_i} = qr{(?:[\x00-\xFF])};
${Char::Egreek::not_word}    = qr{(?:[^\x30-\x39\x41-\x5A\x5F\x61-\x7A])};
...
sub Char::Egreek::lcfirst(@) {
    if (@_) {
        my $s = shift @_;
        if (@_ and wantarray) {
            return Char::Egreek::lc(CORE::substr($s,0,1)) . CORE::substr($s,1), @_;
        }
        else {
            return Char::Egreek::lc(CORE::substr($s,0,1)) . CORE::substr($s,1);
        }
    }
    else {
        return Char::Egreek::lc(CORE::substr($_,0,1)) . CORE::substr($_,1);
    }
}
...
sub Char::Egreek::ucfirst(@) {
    if (@_) {
        my $s = shift @_;
        if (@_ and wantarray) {
            return Char::Egreek::uc(CORE::substr($s,0,1)) . CORE::substr($s,1), @_;
        }
        else {
            return Char::Egreek::uc(CORE::substr($s,0,1)) . CORE::substr($s,1);
        }
    }
    else {
        return Char::Egreek::uc(CORE::substr($_,0,1)) . CORE::substr($_,1);
    }
}
    ...
    for my $string (@string) {
        ...
        for (my $i=0; $i <= $#char; $i++) {
            ...
            # with /i modifier
                ...
                my $uc = Char::Egreek::uc($char[$i]);
                my $fc = Char::Egreek::fc($char[$i]);
                if ($uc ne $fc) {
                    if (CORE::length($fc) == 1) {
                        $char[$i] = '['   . $uc       . $fc . ']';
                    }
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # POSIX-style character classes
            ...
            $char[$i] = {
                ...
                '[:^lower:]'  => '${Char::Egreek::not_lower_i}',
                '[:^upper:]'  => '${Char::Egreek::not_upper_i}',
            ...
            $char[$i] = {
                ...
                '[:^alnum:]'  => '${Char::Egreek::not_alnum}',
                '[:^alpha:]'  => '${Char::Egreek::not_alpha}',
                '[:^ascii:]'  => '${Char::Egreek::not_ascii}',
                '[:^blank:]'  => '${Char::Egreek::not_blank}',
                '[:^cntrl:]'  => '${Char::Egreek::not_cntrl}',
                '[:^digit:]'  => '${Char::Egreek::not_digit}',
                '[:^graph:]'  => '${Char::Egreek::not_graph}',
                '[:^lower:]'  => '${Char::Egreek::not_lower}',
                '[:^print:]'  => '${Char::Egreek::not_print}',
                '[:^punct:]'  => '${Char::Egreek::not_punct}',
                '[:^space:]'  => '${Char::Egreek::not_space}',
                '[:^upper:]'  => '${Char::Egreek::not_upper}',
                '[:^word:]'   => '${Char::Egreek::not_word}',
                '[:^xdigit:]' => '${Char::Egreek::not_xdigit}',
            ...
            for (@singleoctet) {
                while (s/ \A \\x(..) - \\x(..) //oxms or s/ \A \\x((..)) //oxms) {
                    for my $ord (hex($1) .. hex($2)) {
                        ...
                        my $uc = Char::Egreek::uc($char);
                        my $fc = Char::Egreek::fc($char);
                        if ($uc eq $fc) {
...
#               $pattern .= "(?:$your_char)",   # UNIX style
            ...
            elsif ((my $fc = Char::Egreek::fc($char)) ne $char) {
                $pattern .= $fc;
            }
            else {
        ...
        my $matchsub = sub { Char::Egreek::fc($_[0]) =~ /\A $pattern \z/xms };
...
INNER:
        for my $leaf (@leaf) {
            ...
            if (Char::Egreek::index($leaf,'.') == -1 and   # if name does not have a dot in it *and*
                CORE::length($leaf) <= 8 and        # name is shorter than or equal to 8 chars *and*
                Char::Egreek::index($pattern,'\\.') != -1  # pattern has a dot.
            ) {
                if (&$matchsub("$leaf.")) {
                    push @matched, "$head$leaf";
                    next INNER;
...
sub Char::Greek::getc(;*@) {
    ...
    croak 'Too many arguments for Char::Greek::getc' if @_ and not wantarray;
    ...
    for my $length ($length[0] .. $length[-1]) {
        ...
        if (exists $range_tr{CORE::length($getc)}) {
            if ($getc =~ /\A ${Char::Egreek::dot_s} \z/oxms) {
...
sub Char::Greek::index($$;$) {
    ...
    my $index;
    if (@_ == 3) {
        $index = Char::Egreek::index($_[0], $_[1], CORE::length(Char::Greek::substr($_[0], 0, $_[2])));
    }
    else {
        $index = Char::Egreek::index($_[0], $_[1]);
    }
    ...
    if ($index == -1) {
        ...
        return Char::Greek::length(CORE::substr $_[0], 0, $index);
    }
}
...
sub Char::Greek::rindex($$;$) {
    ...
    my $rindex;
    if (@_ == 3) {
        $rindex = Char::Egreek::rindex($_[0], $_[1], CORE::length(Char::Greek::substr($_[0], 0, $_[2])));
    }
    else {
        $rindex = Char::Egreek::rindex($_[0], $_[1]);
    }
    ...
    if ($rindex == -1) {
        ...
        return Char::Greek::length(CORE::substr $_[0], 0, $rindex);
    }
}
...
my $qq_substr  = qr{(?: Char::Greek::substr | CORE::substr | substr ) \( $qq_paren \)
                 }xms;
...
sub Char::Greek::escape(;$) {
    ...
    while (not /\G \z/oxgc) { # member
        $e_script .= Char::Greek::escape_token();
    }
...
#
# escape Greek token of script
#
sub Char::Greek::escape_token {
...
# $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> Char::Egreek::PREMATCH()
    elsif (/\G ( \$` | \$\{`\} | \$ \s* PREMATCH  \b | \$ \s* \{ \s* PREMATCH  \s* \} | \$ \s* \{\^PREMATCH\}  ) /oxmsgc) {
        $slash = 'div';
        return q{Char::Egreek::PREMATCH()};
    }

# $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> Char::Egreek::MATCH()
    elsif (/\G ( \$& | \$\{&\} | \$ \s* MATCH     \b | \$ \s* \{ \s* MATCH     \s* \} | \$ \s* \{\^MATCH\}     ) /oxmsgc) {
        $slash = 'div';
        return q{Char::Egreek::MATCH()};
    }
...
# $POSTMATCH, ${POSTMATCH}, ${^POSTMATCH} --> Char::Egreek::POSTMATCH()
    elsif (/\G (                 \$ \s* POSTMATCH \b | \$ \s* \{ \s* POSTMATCH \s* \} | \$ \s* \{\^POSTMATCH\} ) /oxmsgc) {
        $slash = 'div';
        return q{Char::Egreek::POSTMATCH()};
    }
...
# while (<WILDCARD>) --- glob
    ...
    # avoid "Error: Runtime exception" of perl version 5.005_03
        ...
        return 'while ($_ = Char::Egreek::glob("' . $1 . '"))';
    }

# while (glob)
    elsif (/\G \b while \s* \( \s* glob \s* \) /oxgc) {
        return 'while ($_ = Char::Egreek::glob_)';
    }

# while (glob(WILDCARD))
    elsif (/\G \b while \s* \( \s* glob \b /oxgc) {
        return 'while ($_ = Char::Egreek::glob';
    }
...
# subroutines of package Char::Egreek
    elsif (/\G \b (CORE:: | ->[ ]* (?: atan2 | [a-z]{2,})) \b  /oxgc) { $slash = 'm//'; return $1;                  }
    elsif (/\G \b Char::Greek::eval       (?= \s* \{ )                /oxgc) { $slash = 'm//'; return 'eval';              }
    elsif (/\G \b Char::Greek::eval    \b (?! \s* => )                /oxgc) { $slash = 'm//'; return 'eval Char::Greek::escape'; }
    elsif (/\G \b bytes::substr \b (?! \s* => )                /oxgc) { $slash = 'm//'; return 'substr';            }
    elsif (/\G \b chop \b          (?! \s* => )                /oxgc) { $slash = 'm//'; return 'Char::Egreek::chop';       }
    elsif (/\G \b bytes::index \b  (?! \s* => )                /oxgc) { $slash = 'm//'; return 'index';             }
    elsif (/\G \b Char::Greek::index \b   (?! \s* => )                /oxgc) { $slash = 'm//'; return 'Char::Greek::index';       }
    elsif (/\G \b index \b         (?! \s* => )                /oxgc) { $slash = 'm//'; return 'Char::Egreek::index';      }
    elsif (/\G \b bytes::rindex \b (?! \s* => )                /oxgc) { $slash = 'm//'; return 'rindex';            }
    elsif (/\G \b Char::Greek::rindex \b  (?! \s* => )                /oxgc) { $slash = 'm//'; return 'Char::Greek::rindex';      }
    elsif (/\G \b rindex \b        (?! \s* => )                /oxgc) { $slash = 'm//'; return 'Char::Egreek::rindex';     }
    elsif (/\G \b lc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Egreek::lc';         }
    elsif (/\G \b lcfirst (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Egreek::lcfirst';    }
    elsif (/\G \b uc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Egreek::uc';         }
    elsif (/\G \b ucfirst (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Egreek::ucfirst';    }
    elsif (/\G \b fc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Egreek::fc';         }
    ...
    elsif (/\G \b chr           (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Egreek::chr';               }
    elsif (/\G \b bytes::ord    (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'div'; return 'ord';                      }
    elsif (/\G \b ord           (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'div'; return $function_ord;              }
    elsif (/\G \b glob          (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Egreek::glob';              }
    elsif (/\G \b lc \b            (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Egreek::lc_';               }
    elsif (/\G \b lcfirst \b       (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Egreek::lcfirst_';          }
    elsif (/\G \b uc \b            (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Egreek::uc_';               }
    elsif (/\G \b ucfirst \b       (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Egreek::ucfirst_';          }
    elsif (/\G \b fc \b            (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Egreek::fc_';               }
    ...
    elsif (/\G \b chr \b           (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Egreek::chr_';              }
    elsif (/\G \b bytes::ord \b    (?! \s* => )                      /oxgc) { $slash = 'div'; return 'ord';                      }
    elsif (/\G \b ord \b           (?! \s* => )                      /oxgc) { $slash = 'div'; return $function_ord_;             }
    elsif (/\G \b glob \b          (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Egreek::glob_';             }
...
# end of split
        if    (/\G (?= [,;\)\}\]] )          /oxgc) { return 'Char::Egreek::split' . $e;                 }

# split scalar value
        elsif (/\G ( [\$\@\&\*] $qq_scalar ) /oxgc) { return 'Char::Egreek::split' . $e . e_string($1);  }

# split literal space
        elsif (/\G \b qq       (\#) [ ] (\#) /oxgc) { return 'Char::Egreek::split' . $e . qq  {qq$1 $2}; }
        elsif (/\G \b qq (\s*) (\() [ ] (\)) /oxgc) { return 'Char::Egreek::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq (\s*) (\{) [ ] (\}) /oxgc) { return 'Char::Egreek::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq (\s*) (\[) [ ] (\]) /oxgc) { return 'Char::Egreek::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq (\s*) (\<) [ ] (\>) /oxgc) { return 'Char::Egreek::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq (\s*) (\S) [ ] (\2) /oxgc) { return 'Char::Egreek::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b q        (\#) [ ] (\#) /oxgc) { return 'Char::Egreek::split' . $e . qq   {q$1 $2}; }
        elsif (/\G \b q  (\s*) (\() [ ] (\)) /oxgc) { return 'Char::Egreek::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  (\s*) (\{) [ ] (\}) /oxgc) { return 'Char::Egreek::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  (\s*) (\[) [ ] (\]) /oxgc) { return 'Char::Egreek::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  (\s*) (\<) [ ] (\>) /oxgc) { return 'Char::Egreek::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  (\s*) (\S) [ ] (\2) /oxgc) { return 'Char::Egreek::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G                ' [ ] '    /oxgc) { return 'Char::Egreek::split' . $e . qq     {' '};  }
        elsif (/\G                " [ ] "    /oxgc) { return 'Char::Egreek::split' . $e . qq     {" "};  }
...
# $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> @{[Char::Egreek::PREMATCH()]}
            ...
            $e_string .= q{Char::Egreek::PREMATCH()};
            $slash = 'div';
        }

# $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> @{[Char::Egreek::MATCH()]}
        elsif ($string =~ /\G ( \$& | \$\{&\} | \$ \s* MATCH     \b | \$ \s* \{ \s* MATCH     \s* \} | \$ \s* \{\^MATCH\}     ) /oxmsgc) {
            $e_string .= q{Char::Egreek::MATCH()};
            $slash = 'div';
        }
...
# $POSTMATCH, ${POSTMATCH}, ${^POSTMATCH} --> @{[Char::Egreek::POSTMATCH()]}
            ...
            $e_string .= q{Char::Egreek::POSTMATCH()};
            $slash = 'div';
        }
...
# subroutines of package Char::Egreek
        ...
        elsif ($string =~ /\G \b Char::Greek::eval       (?= \s* \{ )                /oxgc) { $e_string .= 'eval';              $slash = 'm//'; }
        elsif ($string =~ /\G \b Char::Greek::eval \b                                /oxgc) { $e_string .= 'eval Char::Greek::escape'; $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::substr \b                             /oxgc) { $e_string .= 'substr';            $slash = 'm//'; }
        elsif ($string =~ /\G \b chop \b                                      /oxgc) { $e_string .= 'Char::Egreek::chop';       $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::index \b                              /oxgc) { $e_string .= 'index';             $slash = 'm//'; }
        elsif ($string =~ /\G \b Char::Greek::index \b                               /oxgc) { $e_string .= 'Char::Greek::index';       $slash = 'm//'; }
        elsif ($string =~ /\G \b index \b                                     /oxgc) { $e_string .= 'Char::Egreek::index';      $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::rindex \b                             /oxgc) { $e_string .= 'rindex';            $slash = 'm//'; }
        elsif ($string =~ /\G \b Char::Greek::rindex \b                              /oxgc) { $e_string .= 'Char::Greek::rindex';      $slash = 'm//'; }
        elsif ($string =~ /\G \b rindex \b                                    /oxgc) { $e_string .= 'Char::Egreek::rindex';     $slash = 'm//'; }
        elsif ($string =~ /\G \b lc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Egreek::lc';         $slash = 'm//'; }
        elsif ($string =~ /\G \b lcfirst (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Egreek::lcfirst';    $slash = 'm//'; }
        elsif ($string =~ /\G \b uc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Egreek::uc';         $slash = 'm//'; }
        elsif ($string =~ /\G \b ucfirst (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Egreek::ucfirst';    $slash = 'm//'; }
        elsif ($string =~ /\G \b fc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Egreek::fc';         $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b chr           (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Egreek::chr';               $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b glob          (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Egreek::glob';              $slash = 'm//'; }
        elsif ($string =~ /\G \b lc \b                                              /oxgc) { $e_string .= 'Char::Egreek::lc_';               $slash = 'm//'; }
        elsif ($string =~ /\G \b lcfirst \b                                         /oxgc) { $e_string .= 'Char::Egreek::lcfirst_';          $slash = 'm//'; }
        elsif ($string =~ /\G \b uc \b                                              /oxgc) { $e_string .= 'Char::Egreek::uc_';               $slash = 'm//'; }
        elsif ($string =~ /\G \b ucfirst \b                                         /oxgc) { $e_string .= 'Char::Egreek::ucfirst_';          $slash = 'm//'; }
        elsif ($string =~ /\G \b fc \b                                              /oxgc) { $e_string .= 'Char::Egreek::fc_';               $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b chr \b                                             /oxgc) { $e_string .= 'Char::Egreek::chr_';              $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::ord \b                                      /oxgc) { $e_string .= 'ord';                      $slash = 'div'; }
        elsif ($string =~ /\G \b ord \b                                             /oxgc) { $e_string .= $function_ord_;             $slash = 'div'; }
        elsif ($string =~ /\G \b glob \b                                            /oxgc) { $e_string .= 'Char::Egreek::glob_';             $slash = 'm//'; }
...
# end of split
            if    ($string =~ /\G (?= [,;\)\}\]] )          /oxgc) { return 'Char::Egreek::split' . $e;                                           }

# split scalar value
            elsif ($string =~ /\G ( [\$\@\&\*] $qq_scalar ) /oxgc) { $e_string .= 'Char::Egreek::split' . $e . e_string($1);  next E_STRING_LOOP; }

# split literal space
            elsif ($string =~ /\G \b qq       (\#) [ ] (\#) /oxgc) { $e_string .= 'Char::Egreek::split' . $e . qq  {qq$1 $2}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq (\s*) (\() [ ] (\)) /oxgc) { $e_string .= 'Char::Egreek::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq (\s*) (\{) [ ] (\}) /oxgc) { $e_string .= 'Char::Egreek::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq (\s*) (\[) [ ] (\]) /oxgc) { $e_string .= 'Char::Egreek::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq (\s*) (\<) [ ] (\>) /oxgc) { $e_string .= 'Char::Egreek::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq (\s*) (\S) [ ] (\2) /oxgc) { $e_string .= 'Char::Egreek::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q        (\#) [ ] (\#) /oxgc) { $e_string .= 'Char::Egreek::split' . $e . qq   {q$1 $2}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  (\s*) (\() [ ] (\)) /oxgc) { $e_string .= 'Char::Egreek::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  (\s*) (\{) [ ] (\}) /oxgc) { $e_string .= 'Char::Egreek::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  (\s*) (\[) [ ] (\]) /oxgc) { $e_string .= 'Char::Egreek::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  (\s*) (\<) [ ] (\>) /oxgc) { $e_string .= 'Char::Egreek::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  (\s*) (\S) [ ] (\2) /oxgc) { $e_string .= 'Char::Egreek::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G                ' [ ] '    /oxgc) { $e_string .= 'Char::Egreek::split' . $e . qq     {' '};  next E_STRING_LOOP; }
            elsif ($string =~ /\G                " [ ] "    /oxgc) { $e_string .= 'Char::Egreek::split' . $e . qq     {" "};  next E_STRING_LOOP; }
...
sub character_class {
    ...
    if ($char eq '.') {
        if ($modifier =~ /s/) {
            return '${Char::Egreek::dot_s}';
        }
        else {
            return '${Char::Egreek::dot}';
        }
    }
    else {
        return Char::Egreek::classic_character_class($char);
    }
}
...
sub e_tr {
    ...
    if ($modifier =~ tr/bB//d) {
        ...
        if ($variable eq '') {
            $e_tr = qq{Char::Egreek::tr(\$_,' =~ ',$charclass,$e$charclass2,'$modifier')};
        }
        else {
            $e_tr = qq{Char::Egreek::tr($variable,'$bind_operator',$charclass,$e$charclass2,'$modifier')};
        }
    }
...
sub e_qq {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # octal escape sequence
            ...
            $char[$i] = Char::Egreek::octchr($1);
        }

        # hexadecimal escape sequence
        elsif ($char[$i] =~ /\A \\x \{ ([0-9A-Fa-f]+) \} \z/oxms) {
            $char[$i] = Char::Egreek::hexchr($1);
        }
        ...
        # \u \l \U \L \F \Q \E
            ...
            $char[$i] = '@{[Char::Egreek::ucfirst qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\l') {
            $char[$i] = '@{[Char::Egreek::lcfirst qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\U') {
            $char[$i] = '@{[Char::Egreek::uc qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\L') {
            $char[$i] = '@{[Char::Egreek::lc qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\F') {
            $char[$i] = '@{[Char::Egreek::fc qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\Q') {
...
sub e_qr {
    ...
    for (my $i=0; $i <= $#char; $i++) {
            ...
            while (1) {
                ...
                if ($char[$i] eq ']') {
                    ...
                    if (grep(/\A [\$\@]/oxms,@char[$left+1..$right-1]) >= 1) {
                        splice @char, $left, $right-$left+1, sprintf(q{@{[Char::Egreek::charlist_qr(%s,'%s')]}}, join(',', map {qq_stuff($delimiter,$end_delimiter,$_)} @char[$left+1..$right-1]), $modifier);
                    }
                    else {
                        splice @char, $left, $right-$left+1, Char::Egreek::charlist_qr(@char[$left+1..$right-1], $modifier);
                    }
        ...
        # open character class [^...]
            ...
            while (1) {
                ...
                if ($char[$i] eq ']') {
                    ...
                    # [^...]
                    if (grep(/\A [\$\@]/oxms,@char[$left+1..$right-1]) >= 1) {
                        splice @char, $left, $right-$left+1, sprintf(q{@{[Char::Egreek::charlist_not_qr(%s,'%s')]}}, join(',', map {qq_stuff($delimiter,$end_delimiter,$_)} @char[$left+1..$right-1]), $modifier);
                    }
                    else {
                        splice @char, $left, $right-$left+1, Char::Egreek::charlist_not_qr(@char[$left+1..$right-1], $modifier);
                    }
        ...
        # /i modifier
        elsif ($ignorecase and ($char[$i] =~ /\A [\x00-\xFF] \z/oxms) and (Char::Egreek::uc($char[$i]) ne Char::Egreek::fc($char[$i]))) {
            if (CORE::length(Char::Egreek::fc($char[$i])) == 1) {
                $char[$i] = '['   . Char::Egreek::uc($char[$i])       . Char::Egreek::fc($char[$i]) . ']';
            }
            else {
                $char[$i] = '(?:' . Char::Egreek::uc($char[$i]) . '|' . Char::Egreek::fc($char[$i]) . ')';
            }
        ...
        # $0 --> $0
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Char::Egreek::ignorecase(' . $char[$i] . ')]}';
            }
        }
        elsif ($char[$i] =~ /\A \$ \{ \s* 0 \s* \} \z/oxms) {
            if ($ignorecase) {
        ...
        # $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> Char::Egreek::PREMATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Char::Egreek::ignorecase(Char::Egreek::PREMATCH())]}';
            }
            else {
                $char[$i] = '@{[Char::Egreek::PREMATCH()]}';
            }
        ...
        # $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> Char::Egreek::MATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Char::Egreek::ignorecase(Char::Egreek::MATCH())]}';
            }
            else {
                $char[$i] = '@{[Char::Egreek::MATCH()]}';
            }
        ...
        # $POSTMATCH, ${POSTMATCH}, ${^POSTMATCH} --> Char::Egreek::POSTMATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Char::Egreek::ignorecase(Char::Egreek::POSTMATCH())]}';
            }
            else {
                $char[$i] = '@{[Char::Egreek::POSTMATCH()]}';
            }
...
sub e_sub {
    ...
    if ($r_modifier) {
        ...
        # s///gr without multibyte anchoring
            ...
            $sub = sprintf(
                #                              1                        2   3                                 4   5
                q<CORE::eval{local $Char::Greek::re_t=%s; while($Char::Greek::re_t =~ %s){%s local $^W=0; local $Char::Greek::re_r=%s; %s$Char::Greek::re_t="$`$Char::Greek::re_r$'"; pos($Char::Greek::re_t)=length "$`$Char::Greek::re_r"; } return $Char::Greek::re_t}>,
                ...
                $s_matched,                                                      #  3
                $e_replacement,                                                  #  4
                '$Char::Greek::re_r=CORE::eval $Char::Greek::re_r; ' x $e_modifier,            #  5
            );
        }
        ...
        # s///r
            ...
            $sub = sprintf(
                #  1     2                3                                 4   5  6                    7
                q<(%s =~ %s) ? CORE::eval{%s local $^W=0; local $Char::Greek::re_r=%s; %s"%s$Char::Greek::re_r$'" } : %s>,
    ...
    # without /r
        ...
        # s///g without multibyte anchoring
            ...
            $sub = sprintf(
                #                                       1     2   3                                 4   5 6                         7                                                 8
                q<CORE::eval{local $Char::Greek::re_n=0; while(%s =~ %s){%s local $^W=0; local $Char::Greek::re_r=%s; %s%s="$`$Char::Greek::re_r$'"; pos(%s)=length "$`$Char::Greek::re_r"; $Char::Greek::re_n++} return %s$Char::Greek::re_n}>,
        ...
        # s///
            ...
            $sub = sprintf(
                ...
                #  1 2 3                4                                 5   6 7   8
                q<(%s%s%s) ? CORE::eval{%s local $^W=0; local $Char::Greek::re_r=%s; %s%s="%s$Char::Greek::re_r$'"; 1 } : undef> :

                #  1 2 3                    4                                 5   6 7   8
                q<(%s%s%s) ? 1 : CORE::eval{%s local $^W=0; local $Char::Greek::re_r=%s; %s%s="%s$Char::Greek::re_r$'"; undef }>,
                ...
                $s_matched,                                                      #  4
                $e_replacement,                                                  #  5
                '$Char::Greek::re_r=CORE::eval $Char::Greek::re_r; ' x $e_modifier,            #  6
                $variable,                                                       #  7
                $prematch,                                                       #  8
            );
        }
...
sub e_split {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # ${ foo }
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Char::Egreek::ignorecase(' . $1 . ')]}';
            }
        }
    ...
    $modifier =~ tr/i//d;
    if ($left_e > $right_e) {
        return join '', 'Char::Egreek::split', $ope, $delimiter, @char, '>]}' x ($left_e - $right_e), $end_delimiter, $modifier;
    }
    return     join '', 'Char::Egreek::split', $ope, $delimiter, @char,                               $end_delimiter, $modifier;
}
...
=head1 SYNOPSIS
  ...
  use Char::Egreek;
    ...
    Char::Egreek::lc_;
    Char::Egreek::lcfirst(...);
    Char::Egreek::lcfirst_;
    Char::Egreek::uc(...);
    Char::Egreek::uc_;
    Char::Egreek::ucfirst(...);
    Char::Egreek::ucfirst_;
    Char::Egreek::fc(...);
    Char::Egreek::fc_;
    Char::Egreek::ignorecase(...);
    Char::Egreek::capture(...);
    Char::Egreek::chr(...);
    Char::Egreek::chr_;
    Char::Egreek::glob(...);
  ...
  # "no Char::Egreek;" not supported

=head1 ABSTRACT

This module has run-time routines for use Char::Greek software automatically, you
do not have to use.
...
some bugs. Thus, if you happen to find a bug that's in Char::Greek software and not
...
This Char::Egreek module first appeared in ActivePerl Build 522 Built under
...
=item Split string
  ...
  @split = Char::Egreek::split(/pattern/,$string,$limit);
  @split = Char::Egreek::split(/pattern/,$string);
  @split = Char::Egreek::split(/pattern/);
  @split = Char::Egreek::split('',$string,$limit);
  @split = Char::Egreek::split('',$string);
  @split = Char::Egreek::split('');
  @split = Char::Egreek::split();
  @split = Char::Egreek::split;
  ...
  at all, Char::Egreek::split returns the original string as a single substring, If it
  ...
  @chars  = Char::Egreek::split(//,  $word);
  @fields = Char::Egreek::split(/:/, $line);
  @words  = Char::Egreek::split(" ", $paragraph);
  @lines  = Char::Egreek::split(/^/, $buffer);
  ...
  print join(":" => Char::Egreek::split(/ */, "hi there"));
  ...
  Char::Egreek::split's pattern is exempt from that wrinkle.)

  The $limit parameter splits only part of a string:

  my ($login, $passwd, $remainder) = Char::Egreek::split(/:/, $_, 3);
  ...
  splits on whitespace just as Char::Egreek::split with no arguments does. Thus,
  Char::Egreek::split(" ") can be used to emulate awk's default behavior. In contrast,
  Char::Egreek::split(/ /) will give you as many null initial fields as there are
  ...
  $string = join(" ", Char::Egreek::split(" ", $string));
  ...
  %head = ("FRONTSTUFF", Char::Egreek::split(/^(\S*?):\s*/m, $header));
  ...
  while (<>) {
      for my $word (Char::Egreek::split()) {
          $count{$word}++;
      }
  }

  The inverse of Char::Egreek::split is join, except that join can only join with the
...
=item Transliteration
  ...
  $tr = Char::Egreek::tr($variable,$bind_operator,$searchlist,$replacementlist,$modifier);
  $tr = Char::Egreek::tr($variable,$bind_operator,$searchlist,$replacementlist);
  ...
  print Char::Egreek::tr('bookkeeper','=~','boep','peob','r'); # prints 'peekkoobor'

=item Chop string

  $chop = Char::Egreek::chop(@list);
  $chop = Char::Egreek::chop();
  $chop = Char::Egreek::chop;

  This subroutine chops off the last character of a string variable and returns the
  character chopped. The Char::Egreek::chop subroutine is used primary to remove the newline
  ...
  since Char::Egreek::chop always shortens the string no matter what's there, and chomp
  is more selective. If no argument is given, the subroutine chops the $_ variable.

  You cannot Char::Egreek::chop a literal, only a variable. If you Char::Egreek::chop a list of
  variables, each string in the list is chopped:

  @lines = `cat myfile`;
  Char::Egreek::chop(@lines);

  You can Char::Egreek::chop anything that is an lvalue, including an assignment:

  Char::Egreek::chop($cwd = `pwd`);
  Char::Egreek::chop($answer = <STDIN>);

  This is different from:

  $answer = Char::Egreek::chop($tmp = <STDIN>); # WRONG

  which puts a newline into $answer because Char::Egreek::chop returns the character
  ...
  In the most general case, Char::Egreek::chop can be expressed using substr:

  $last_code = Char::Egreek::chop($var);
  $last_code = substr($var, -1, 1, ""); # same thing

  Once you understand this equivalence, you can use it to do bigger chops. To
  Char::Egreek::chop more than one character, use substr as an lvalue, assigning a null
  ...
  form of substr, creating something of a quintuple Char::Egreek::chop;
...
=item Index string
  ...
  $byte_pos = Char::Egreek::index($string,$substr,$byte_offset);
  $byte_pos = Char::Egreek::index($string,$substr);
  ...
  $byte_pos = -1;
  while (($byte_pos = Char::Egreek::index($string, $lookfor, $byte_pos)) > -1) {
...
=item Reverse index string
  ...
  $byte_pos = Char::Egreek::rindex($string,$substr,$byte_offset);
  $byte_pos = Char::Egreek::rindex($string,$substr);

  This subroutine works just like Char::Egreek::index except that it returns the byte
  position of the last occurrence of $substring in $string (a reverse Char::Egreek::index).
  ...
  while (($byte_pos = Char::Greek::rindex($string, $lookfor, $byte_pos)) >= 0) {
      print "Found at $byte_pos\n";
      $byte_pos--;
  }
...
=item Lower case string
  ...
  You can use the Char::Egreek::fc subroutine for case-insensitive comparisons via Char::Greek
  software.

=item Lower case first character of string

  $lcfirst = Char::Egreek::lcfirst($string);
  $lcfirst = Char::Egreek::lcfirst_;
...
=item Upper case string
  ...
  in interpolated strings. For titlecase, use Char::Egreek::ucfirst instead.
...
=item Upper case first character of string
  ...
  $ucfirst = Char::Egreek::ucfirst($string);
  $ucfirst = Char::Egreek::ucfirst_;
  ...
  $titlecase = Char::Egreek::ucfirst(substr($word,0,1)) . Char::Egreek::lc(substr($word,1));
  ...
  $do_not_use = Char::Egreek::ucfirst(Char::Egreek::lc($word));
...
=item Fold case string
  ...
  $fc = Char::Egreek::fc($string);
  $fc = Char::Egreek::fc_;

  New to Char::Greek software, this subroutine returns the full Unicode-like casefold of
  ...
  Char::Egreek::fc($a) eq Char::Egreek::fc($b)

  The reliable way to compare string case-insensitively was with the /i pattern
  modifier, because Char::Greek software has always used casefolding semantics for
...
=item Make ignore case string
  ...
  @ignorecase = Char::Egreek::ignorecase(@string);

  This subroutine is internal use to m/ /i, s/ / /i, split / /i, and qr/ /i.

=item Make capture number

  $capturenumber = Char::Egreek::capture($string);

  This subroutine is internal use to m/ /, s/ / /, split / /, and qr/ /.

=item Make character

  $chr = Char::Egreek::chr($code);
  $chr = Char::Egreek::chr_;

  This subroutine returns a programmer-visible character, character represented by
  that $code in the character set. For example, Char::Egreek::chr(65) is "A" in either
  ASCII or Greek, not Unicode. For the reverse of Char::Egreek::chr, use Char::Greek::ord.

=item Filename expansion (globbing)

  @glob = Char::Egreek::glob($string);
  @glob = Char::Egreek::glob_;
  ...
  The Char::Egreek::glob subroutine grandfathers the use of whitespace to separate multiple
  ...
  @spacies = <"*e f*">;
  @spacies = Char::Egreek::glob('"*e f*"');
  @spacies = Char::Egreek::glob(q("*e f*"));

  If you had to get a variable through, you could do this:

  @spacies = Char::Egreek::glob("'*${var}e f*'");
  @spacies = Char::Egreek::glob(qq("*${var}e f*"));
