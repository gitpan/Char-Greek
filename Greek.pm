...
sub e_qr {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # /i modifier
        elsif ($ignorecase and (Egreek::uc($char[$i]) ne Egreek::lc($char[$i]))) {
...
=item * Only Greek.pm and Egreek.pm, other modules are unnecessary
...
functions.
  ...
  ---------------------------------
  lc          Egreek::lc
  lcfirst     Egreek::lcfirst
  uc          Egreek::uc
  ucfirst     Egreek::ucfirst
  chr         Egreek::chr
  glob        Egreek::glob
  ---------------------------------
...
Greek.pm remove 'bytes::' at head of function name.
...
=head1 Perl5.6 Emulation on perl5.005
  ...
  --------------------------------------------------------------------
  Before          After                  in BEGIN { } of Egreek.pm
  --------------------------------------------------------------------
  binmode(...);   Egreek::binmode(...);   *CORE::GLOBAL::binmode = ...
  open(...);      Egreek::open(...);      *CORE::GLOBAL::open    = ...
  --------------------------------------------------------------------
...
=item * binmode (Perl5.6 emulation on perl5.005)
  ...
  * two arguments
  ...
  If you are using perl5.005, Greek software emulate perl5.6's binmode function.
...
=item * open (Perl5.6 emulation on perl5.005)
  ...
  * three arguments
  ...
  If you are using perl5.005, Greek software emulate perl5.6's open function.
  ...
  open(FH, "<:crlf:encoding(Greek)", $path) or die "can't open $path: $!";
...
=head1 Ignore utf8 pragma
  ...
  ---------------------------------------------------------------------
  use utf8;       # use utf8;            Egreek.pm provides utf8::*
  no utf8;        # no utf8;             functions even if 'no utf8;'
  use bytes;      # use bytes;           Egreek.pm provides bytes::*
