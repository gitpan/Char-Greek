...
=head1 Un-Escaping \ of \N, \p, \P, and \X (Greek software provides)

Greek software removes '\' at head of alphanumeric regexp metasymbols \N, \p, \P
...
=head1 Escaping Built-in Functions (Greek software provide)
