...
# subroutines of package Egreek
    ...
    elsif (/\G \b Greek::eval       (?= \s* \{ )                /oxgc) { $slash = 'm//'; return 'eval';              }
    elsif (/\G \b Greek::eval    \b (?! \s* => )                /oxgc) { $slash = 'm//'; return 'eval Greek::escape'; }
...
# subroutines of package Egreek
        ...
        elsif ($string =~ /\G \b Greek::eval       (?= \s* \{ )                /oxgc) { $e_string .= 'eval';              $slash = 'm//'; }
        elsif ($string =~ /\G \b Greek::eval \b                                /oxgc) { $e_string .= 'eval Greek::escape'; $slash = 'm//'; }
...
sub e_sub {
    ...
    if ($r_modifier) {
        ...
        # s///gr without multibyte anchoring
            ...
            $sub = sprintf(
                #                              1                        2   3                                 4   5
                q<CORE::eval{local $Greek::re_t=%s; while($Greek::re_t =~ %s){%s local $^W=0; local $Greek::re_r=%s; %s$Greek::re_t="$`$Greek::re_r$'"; pos($Greek::re_t)=length "$`$Greek::re_r"; } return $Greek::re_t}>,
                ...
                $s_matched,                                                      #  3
                $e_replacement,                                                  #  4
                '$Greek::re_r=CORE::eval $Greek::re_r; ' x $e_modifier,            #  5
            );
        }
        ...
        # s///r
            ...
            $sub = sprintf(
                #  1     2                3                                 4   5  6                    7
                q<(%s =~ %s) ? CORE::eval{%s local $^W=0; local $Greek::re_r=%s; %s"%s$Greek::re_r$'" } : %s>,
    ...
    # without /r
        ...
        # s///g without multibyte anchoring
            ...
            $sub = sprintf(
                #                                       1     2   3                                 4   5 6                         7                                                 8
                q<CORE::eval{local $Greek::re_n=0; while(%s =~ %s){%s local $^W=0; local $Greek::re_r=%s; %s%s="$`$Greek::re_r$'"; pos(%s)=length "$`$Greek::re_r"; $Greek::re_n++} return %s$Greek::re_n}>,
        ...
        # s///
            ...
            $sub = sprintf(
                ...
                #  1 2 3                4                                 5   6 7   8
                q<(%s%s%s) ? CORE::eval{%s local $^W=0; local $Greek::re_r=%s; %s%s="%s$Greek::re_r$'"; 1 } : undef> :

                #  1 2 3                    4                                 5   6 7   8
                q<(%s%s%s) ? 1 : CORE::eval{%s local $^W=0; local $Greek::re_r=%s; %s%s="%s$Greek::re_r$'"; undef }>,
                ...
                $s_matched,                                                      #  4
                $e_replacement,                                                  #  5
                '$Greek::re_r=CORE::eval $Greek::re_r; ' x $e_modifier,            #  6
                $variable,                                                       #  7
                $prematch,                                                       #  8
            );
        }
