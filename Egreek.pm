...
=item Make character
  ...
  set. For example, Egreek::chr(65) is "A" in either ASCII or Greek, not Unicode,
  and Egreek::chr(0x82a0) is a Greek HIRAGANA LETTER A. For the reverse of
  Egreek::chr, use Greek::ord.
